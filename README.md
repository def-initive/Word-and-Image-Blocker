GreaseMonkey / ViolentMonkey scripts. This uses two scripts, the blocking script and a second UI / Settings script that lets you add words and phrases to be blocked.
